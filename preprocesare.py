...
input_folder = "E:\\AN4\\licenta\\preproc_train\\Raw_Data"


base_output_folders = {
    "waveforms": "E:\\AN4\\licenta\\preproc_train\\waveforms",
    "segmented_audio": "E:\\AN4\\licenta\\preproc_train\\segmented_audio",
    "fft_representations": "E:\\AN4\\licenta\\preproc_train\\fft_representations",
    "mel_spectrograms": "E:\\AN4\\licenta\\preproc_train\\mel_spectrograms",    
    #"masked_mel_spectrograms": "E:\\AN4\\licenta\\dataset_laptop\\masked_mel_spectrograms",
    "mfcc_spectrograms": "E:\\AN4\\licenta\\preproc_train\\mfcc_spectrograms",
    "wavelet_spectrograms": "E:\\AN4\\licenta\\preproc_train\\wavelet_spectrograms"
}
...
for file in os.listdir(input_folder):
    if file.endswith(".wav"):
        ...
        for idx in range(len(filtered_onsets)-1):
            ...
            #plt.tight_layout()
           # output_path = os.path.join(base_output_folders["masked_mel_spectrograms"], letter, f"{segment_name}.png")
            #plt.savefig(output_path, transparent=False, facecolor="white")
            #plt.close()
            #img = Image.open(output_path).convert("RGB")
            #img.save(output_path)
